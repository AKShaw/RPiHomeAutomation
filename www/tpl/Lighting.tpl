...
<paper-toast duration="0" id="help" text="Slide the values for Red, Green and Blue to edit the LED color. You can also toggle them on or off using the switch. This will automatically update the LEDs.">
